  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {/* Mensaje de guardado */}
        {showSaved && (
          <div className="fixed bottom-4 right-4 bg-green-600 text-white px-4 py-3 rounded-lg shadow-lg flex items-center gap-2 animate-in pb-[env(safe-area-inset-bottom,1rem)]">

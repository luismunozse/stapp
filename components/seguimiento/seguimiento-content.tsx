      ...
      <Card>
        <CardContent className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 pt-1">
            {whatsappUrl && (
              <Button variant="outline" size="sm" className="h-12 flex-col gap-1 items-center justify-center text-green-600 border-green-200 hover:bg-green-50 hover:text-green-700 hover:border-green-300" asChild>
            ...
            {data.publicToken && (
              <Button variant="outline" size="sm" className="h-12 flex-col gap-1 items-center justify-center" asChild>

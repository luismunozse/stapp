...
export function WhatsAppButton() {
  return (
    <a
      ...
      className={cn(
        "fixed bottom-[6.5rem] right-6 z-50",
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-3 px-3 py-1.5 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
        Chateá con nosotros
      </span>
    </a>
  )

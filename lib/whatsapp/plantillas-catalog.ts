...
{empresa}`,
  ...
  // === Cobranza ===
  {
    ...
    variables: [VAR_CLIENTE, VAR_SALDO, VAR_SALDO_FIADO, VAR_SALDO_ORDENES, VAR_LINEA_DESGLOSE_PAGO, VAR_NUMERO_ORDEN, VAR_EMPRESA],
    defaultText: `Hola {cliente}, le recordamos que tiene un saldo pendiente de *{saldo}*.{linea_desglose_pago}

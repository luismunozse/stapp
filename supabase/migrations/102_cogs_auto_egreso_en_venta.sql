-- ============================================
-- Migration 102: Egreso automático de costo de mercadería en ventas
-- ============================================
-- Problema: al vender un producto que costó $10.000 a $20.000, la caja
-- muestra $20.000 de ingreso sin descontar los $10.000 del costo.
--
-- Solución: crear_venta_atomica ahora inserta un movimiento de caja
-- tipo EGRESO por el costo total de los productos vendidos (COGS).
-- Se marca con afecta_rentabilidad = FALSE para no duplicar en el P&L
-- (que ya calcula COGS desde items_venta.costo_unitario_snapshot).
-- ============================================
...
BEGIN
  ...
  -- 7. NUEVO: Registrar egreso automático por costo de mercadería vendida

...
-- reproduciblemente, los cuatro escenarios que 309 tiene que distinguir.
--
-- Los cuatro escenarios (uno por cliente sintético):
...
-- ---------------------------------------------------------------------------
-- Fixture: una organización, una sucursal y cuatro clientes sintéticos, uno
...
-- Órdenes: todas ENTREGADO, todas con costo_final fijado en la entrega. El
-- filtro de la RPC no mira `estado`, solo `estado_cobro`, pero ENTREGADO es
-- el estado real en el que ocurre el bug (ver mig 309, comentario FIX).
...
-- ---------------------------------------------------------------------------
INSERT INTO _r
SELECT 0, 'setup: 4 ordenes + 4 clientes creados', '4 / 4',
...
-- ---------------------------------------------------------------------------
-- PROBE 5 — El REVOKE/GRANT de la RPC sigue en pie. La función es SECURITY
...
-- ---------------------------------------------------------------------------
INSERT INTO _r
SELECT 5, 'permisos: public/anon/authenticated sin EXECUTE, service_role con EXECUTE',

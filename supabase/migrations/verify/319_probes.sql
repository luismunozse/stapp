-- =============================================================================
-- Verificación de la migración 319 — revertir_cargos_orden y columnas de
-- reversa en cuenta_corriente.
--
-- CÓMO CORRERLO (ver verify/README.md):
--   - SQL editor de Supabase Studio, DESPUES de aplicar 319.
...
-- teléfonos claramente namespaceados 'probe-319-...') porque el RPC bajo
...
BEGIN
  INSERT INTO organizations (nombre, slug)
    VALUES ('Probe 319 Org A', 'probe-319-org-a') RETURNING id INTO v_org_a;
  INSERT INTO organizations (nombre, slug)
    VALUES ('Probe 319 Org B', 'probe-319-org-b') RETURNING id INTO v_org_b;

  INSERT INTO sucursales (organization_id, nombre)
    VALUES (v_org_a, 'Probe 319 Sucursal 1') RETURNING id INTO v_suc_1;
  INSERT INTO sucursales (organization_id, nombre)
    VALUES (v_org_a, 'Probe 319 Sucursal 2') RETURNING id INTO v_suc_2;

  INSERT INTO clientes (nombre, telefono, organization_id)
    VALUES ('Probe 319 Cliente 1', '3110000001', v_org_a) RETURNING id INTO v_cli_1;
  INSERT INTO clientes (nombre, telefono, organization_id)
    VALUES ('Probe 319 Cliente 2', '3110000002', v_org_a) RETURNING id INTO v_cli_2;
  INSERT INTO clientes (nombre, telefono, organization_id)
    VALUES ('Probe 319 Cliente B', '3110000003', v_org_b) RETURNING id INTO v_cli_b;

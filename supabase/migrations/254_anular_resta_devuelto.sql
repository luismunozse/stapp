-- Migration 254: anulación descuenta lo ya devuelto del stock restore.
  ...
  IF OLD.estado = 'COMPLETADA' AND NEW.estado = 'ANULADA' THEN
    ...
    LOOP
      ...
      PERFORM incrementar_stock_deposito(
        v_item.inventario_id, NEW.organization_id, v_dep_origen, GREATEST(v_item.cantidad - v_ya_devuelto, 0));
    END LOOP;

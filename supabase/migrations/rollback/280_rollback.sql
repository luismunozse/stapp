-- Rollback de 280_servicios_orden_atomico.sql
--
...
-- condicion de carrera que corrige 280). No aplicar sin revertir también el
-- código de la ruta a la versión pre-280.

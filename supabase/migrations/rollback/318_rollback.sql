...
-- Rolear hasta 267 en vez de 273 dejaria la base peor que antes de que 318
-- corriera: reabriria el bug de 273 (ordenes CANCELADAS o EN_REPARACION con
-- costo_final sumando como deuda) ademas del que 318 arregla.
--
-- OJO: este rollback reintroduce el bug de doble conteo que 318 arregla — una
...
-- comment in effect right after 273 ran (and right before 318 ran) was still
-- 267's, verbatim, including its stale "Migration 267" signature and the text
-- below that does not mention the estado filter. Restoring 318's rollback

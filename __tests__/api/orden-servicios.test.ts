...
// Desde la migracion 301, agregar/eliminar una linea de servicio corre atomicamente
...
describe("POST /api/ordenes/[id]/servicios", () => {
  ...
  it("relaya costoFinalActualizado=false del RPC cuando la orden ya tiene cobros", async () => {
    ...
    // 301 (SQL) y no es alcanzable a traves de un supabaseAdmin.rpc mockeado.
    // Esta cubierta por PROBE 3 de supabase/migrations/verify/301_probes.sql.
...
describe("DELETE /api/ordenes/[id]/servicios", () => {
  ...
  it("relaya costoFinalActualizado=false del RPC cuando la orden ya tiene cobros", async () => {
    ...
    // la migracion 301 (SQL, PROBE 3 de 301_probes.sql) y no es alcanzable a
  ...
  it("relaya costoFinalActualizado=true y sumaServicios=0 del RPC al eliminar la ultima linea", async () => {
    ...
    // RPC (SQL); esta cubierto por PROBE 4 de supabase/migrations/verify/301_probes.sql,
  ...
  it("relaya costoFinalActualizado=false del RPC cuando la orden esta en REPARADO", async () => {
    // El STATE GUARD que decide esto vive en la migracion 301 (SQL), no en la
    ...
    // supabase/migrations/verify/301_probes.sql (PROBE 5).
